        ...
        <button className="search-button">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M13.9428 13.9428C14.3333 13.5523 14.9665 13.5523 15.357 13.9428L19.707 18.2928C20.0975 18.6833 20.0975 19.3165 19.707 19.707C19.3165 20.0975 18.6833 20.0975 18.2928 19.707L13.9428 15.357C13.5523 14.9665 13.5523 14.3333 13.9428 13.9428Z"
              fill="var(--primary-color)"
            />
          </svg>
        </button>
